...
//Code Here
let evenNumbers = mixedNumbers.filter (function(element, index, wholeArrray){
  return element % 2 === 0;
})
...
let totalPopulation = populations.reduce(function(rt,ce){
  return rt += ce;
})
...
// Do not edit the code below.
const purchases = [{"owner":"Barry","price":103},{"owner":"Bob","price":75},{"owner":"Bob","price":73},
